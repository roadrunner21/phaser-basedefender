...
export default class ExperienceBar extends Container {
    ...
    constructor(scene: GameScene, experience) {
        super(scene);
    ...
    get experienceNextLevel(): number {
        return Experience.getExperience(this.level + 1);
    }
